...
// npm-dist/snippets/oxigraph-js-0c4d9b1c205e5d87/src/data_model.js
var data_model_exports = {};
__export(data_model_exports, {
  factory: () => data_model_default
});
var init_data_model2 = __esm({
  "npm-dist/snippets/oxigraph-js-0c4d9b1c205e5d87/src/data_model.js"() {
    "use strict";
    init_data_model();
  }
...
// npm-dist/node.js
var { factory: factory2 } = (init_data_model2(), __toCommonJS(data_model_exports));
...
exports.QueryTriples = QueryTriples;
var Store = class {
  __destroy_into_raw() {
    const ptr = this.__wbg_ptr;
    this.__wbg_ptr = 0;
...
var wasmPath = `${__dirname}/node_bg.wasm`;
